...
class captionGen:
    """
    Wrapper for the CaptionGen Model
    """
    def __init__(self):
        """
        Create new model wrapper, load ML Framework model
        """
        self.processor = BlipProcessor.from_pretrained("Salesforce/blip-image-captioning-large")
        self.model = BlipForConditionalGeneration.from_pretrained("Salesforce/blip-image-captioning-large").to(device)

    def blipModel(self, imageurl):
        """
        Runs prediction for an image file provided by an user.
        :returns a caption describing the image
        """
        try:
    ...
    def llmModel(self, caption, tone):
        """
        Runs prediction for a single caption input generated by the BLIP Model
        :returns a caption with a certain tone
        """
