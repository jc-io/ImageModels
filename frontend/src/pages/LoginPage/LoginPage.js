...
const LoginPage = () => {
  ...
  useEffect(() => {
    // Check if "Remember me" is checked and retrieve username and password from localStorage
  ...
  const handleEmailChange = (e) => {
    ...
    setIsFilled(username && e.target.value && password);
  };
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post(`${process.env.REACT_APP_BACKEND_URL}/login`, requestData)
      .then((response) => {
      ...
      .then((data) => {
        ...
        if (data.token) {
          ...
          // Save username and password only if "Remember me" is checked
          if (rememberMe) {
  ...
  return (
    <div className="relative">
      ...
      >
        <source
          src="https://imagegenachieve.s3.amazonaws.com/tokyo-walk.mp4"
          type="video/mp4"
        />
      ...
      <section className="relative bg-transparent">
        ...
        <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
          ...
          >
            ...
            <span className="self-center text-2xl font-semibold whitespace-nowrap text-transparent bg-clip-text bg-gradient-to-r to-rose-600 from-lime-400">
              ImageGen
            </span>
          </a>
