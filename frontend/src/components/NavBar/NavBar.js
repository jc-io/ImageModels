...
function NavBar() {
  ...
  const handleSignOut = () => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_BACKEND_URL}/signout`,
        {},
        {
          headers: {
  ...
  useEffect(() => {
    ...
    if (isHome || isSignUp || isLogin) {
      ...
      document
        ...
        .classList.remove("md:text-blue-700");
      document
        .getElementById("navbar")
        .classList.add("border-b", "border-gray-200", "dark:border-gray-600");
    }
    ...
    if (isCaptionGen) {
      //md:text-blue-700
      document
        .getElementById("navbar-caption")
        .classList.add("md:text-blue-700");
    } else {
      document
        .getElementById("navbar-caption")
        .classList.remove("md:text-blue-700");
    ...
    if (isEditImage) {
      //md:text-blue-700
      document
        .getElementById("navbar-editImage")
        .classList.add("md:text-blue-700");
    } else {
      document
        .getElementById("navbar-editImage")
    ...
    if (isImageGen) {
      //md:text-blue-700
      document
        .getElementById("navbar-imageGen")
        .classList.add("md:text-blue-700");
    } else {
      document
        .getElementById("navbar-imageGen")
